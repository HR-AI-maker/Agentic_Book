      ...
      <main className="lg:ml-72 pt-16 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="mb-8 ml-14 sm:ml-16 lg:ml-0">
            ...
            {/* Error Message */}
            {error && (
              <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-900 text-sm inline-block">
                <p className="font-medium">API limit reached. Please use your own API key in .env file.</p>
                <button
                  onClick={() => setError(null)}
                  className="ml-2 text-amber-700 hover:text-amber-900 font-medium underline"
                >
                  Dismiss
                </button>
              </div>
